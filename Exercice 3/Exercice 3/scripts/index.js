...
function onConfirm() {
  ...
  //====Code à rédiger ici======
  if (isControlParentalActive == true && age< ageMajorite){ // pas oblige de mettre le true
    refuser()
  } else { // le else prend en compte si le controle parental est activé mais si tu es majeur ou plus
    valider()
  }
